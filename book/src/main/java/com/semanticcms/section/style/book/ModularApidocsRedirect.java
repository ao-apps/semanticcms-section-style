 ...
 */
package com.semanticcms.section.style.book;
...
@WebServlet("/section/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/section/style/apidocs/com.semanticcms.section.style/com" + Objects.toString(req.getPathInfo(), ""),
